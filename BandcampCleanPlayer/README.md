# Bandcamp Clean Player & Volume Control

A Chrome Extension (Manifest V3) that streamlines Bandcamp album and track pages.
...
4. Select the `BandcampCleanPlayer` folder from this repository.
5. Visit any Bandcamp album or track page (e.g. `https://artist.bandcamp.com/album/...`).
